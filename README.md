...
| **歷史買賣點標記** | 圖表自動以 ▲ 標記歷史買入區（分數 ≥ 3，達「積極加碼」門檻）、▼ 標記歷史賣出區（分數 ≤ -3，達「積極減碼」門檻） |
...
1. **收盤價 + MA20 / MA60 / MA120 + 量比**：觀察均線支撐位，量比（相對 20 日均量）以彩色長條顯示於圖底；紅色 ▲ 標記歷史買入區（分數 ≥ 3，達「積極加碼」門檻）、紫色 ▼ 標記歷史賣出區（分數 ≤ -3，達「積極減碼」門檻）；若有設定持倉成本，另以橘色虛線（成本）與紫色虛線（停利目標）標示
